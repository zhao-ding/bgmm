...
rng(123);
%% left turn
% for leftTurn: mixture_data:SpeedSdv,SpeedTV,Dcp (v,vl,R)
load('leftTurnEvents.mat')
% % distribution histo
% for i = 1:3
%    subplot(3,1,i)
...
for K=K_start:K_end  % Number of Mixtrue
    ...
    filename=['fitting_result_leftTurn_K = ' num2str(K)];
...
xlabel('K');
ylabel('BIC');
saveas(BIC_figure,'BIC_leftTurn.fig');